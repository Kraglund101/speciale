"""Visualize the 9 mint samples that need 5+ groups."""
import sys
import json
import random
import math
...
SAMPLES = [
    ("realiad_1024/mint/NG/QS/S0104/mint_0104_NG_QS_C1_20230910103505.jpg",
     "realiad_1024/mint/NG/QS/S0104/mint_0104_NG_QS_C1_20230910103505.png", "missing_parts"),
    ("realiad_1024/mint/NG/QS/S0104/mint_0104_NG_QS_C2_20230910103505.jpg",
     "realiad_1024/mint/NG/QS/S0104/mint_0104_NG_QS_C2_20230910103505.png", "missing_parts"),
    ("realiad_1024/mint/NG/YW/S0094/mint_0094_NG_YW_C3_20230910113825.jpg",
     "realiad_1024/mint/NG/YW/S0094/mint_0094_NG_YW_C3_20230910113825.png", "foreign_objects"),
    ("realiad_1024/mint/NG/YW/S0136/mint_0136_NG_YW_C1_20230910130948.jpg",
     "realiad_1024/mint/NG/YW/S0136/mint_0136_NG_YW_C1_20230910130948.png", "foreign_objects"),
    ("realiad_1024/mint/NG/YW/S0175/mint_0175_NG_YW_C1_20230910134009.jpg",
     "realiad_1024/mint/NG/YW/S0175/mint_0175_NG_YW_C1_20230910134009.png", "foreign_objects"),
    ("realiad_1024/mint/NG/ZW/S0037/mint_0037_NG_ZW_C1_20230908165818.jpg",
     "realiad_1024/mint/NG/ZW/S0037/mint_0037_NG_ZW_C1_20230908165818.png", "contamination"),
    ("realiad_1024/mint/NG/ZW/S0048/mint_0048_NG_ZW_C4_20230908174748.jpg",
     "realiad_1024/mint/NG/ZW/S0048/mint_0048_NG_ZW_C4_20230908174748.png", "contamination"),
    ("realiad_1024/mint/NG/ZW/S0209/mint_0209_NG_ZW_C1_20230910134956.jpg",
     "realiad_1024/mint/NG/ZW/S0209/mint_0209_NG_ZW_C1_20230910134956.png", "contamination"),
    ("realiad_1024/mint/NG/ZW/S0028/mint_0028_NG_ZW_C4_20230908165720.jpg",
     "realiad_1024/mint/NG/ZW/S0028/mint_0028_NG_ZW_C4_20230908165720.png", "contamination"),
]
...
def main():
    ...
    save_dir = root / "results" / "temp_disjoint_5plus_groups"
    save_dir.mkdir(parents=True, exist_ok=True)

    for si, (ip, mp_path, atype) in enumerate(SAMPLES):
        img_pil = Image.open(str(data_root / ip)).convert("RGB")
        mask_pil = Image.open(str(data_root / mp_path)).convert("L")
        iw, ih = img_pil.size
        ...
        for c in range(1, nc + 1):
            ...
            if bb:
                ...
                comps.append({
                    ...
                    "pbs": pb_size(pad_bb(bb, 0.1, ih, iw)),
                })
        ...
        for g in groups:
            ...
            ginfo.append({
                ...
                "pbbox": mpb, "pbs": pb_size(mpb),
                "area": sum(comps[idx]["area"] for idx in g["idxs"]),
            })

        ncols = 1 + ng
        fig, axes = plt.subplots(2, ncols, figsize=(3.5 * ncols, 9))
        if ncols == 1:
        ...
        csizes = sorted([c["side"] for c in comps], reverse=True)
        axes[1, 0].set_title(f"Full mask\nsizes: {csizes}", fontsize=6)
        axes[1, 0].axis("off")
        ...
        for gi, g in enumerate(ginfo):
            ...
            axes[0, c].set_title(
                ...
                f"r={r224} {nc16}c+{nr16}r={nc16+nr16}/256", fontsize=7)
            axes[0, c].axis("off")

            # Row 1: colored group mask
            col = COLORS[gi % len(COLORS)]
            axes[1, c].imshow(inp)
        ...
        plt.suptitle(
            f"Sample {si} \u2014 {atype} \u2014 "
            f"{nc} comps \u2192 {ng} groups (5+ groups)",
            fontsize=10, fontweight="bold")
        plt.tight_layout(rect=[0.01, 0.02, 1, 0.92])
        plt.savefig(
            save_dir / f"{si:02d}_{atype}_n{nc}_g{ng}.png",
            dpi=130, bbox_inches="tight")
        plt.close()
        gsz = "+".join(f"{g['nc']}c" for g in ginfo)
        print(f"  [{si+1}/9] {atype} {nc}comps -> {ng}grps [{gsz}]")
